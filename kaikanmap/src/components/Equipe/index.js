            ...
            <section id="s2">
                <section id="c1" className="caixas">
                    ...
                    <section id="prede">
                        ...
                        <a className="linkIcon" class="social" target="_blank" href="https://github.com/VitorToku"><i class="bi bi-github icon" /></a>
                        <a className="linkIcon" class="social" target="_blank" href="https://www.instagram.com/vhtoku/"><i class="bi bi-instagram icon"></i></a>
                        <a className="linkIcon" class="social" target="_blank" href="https://www.linkedin.com/in/vitor-tokunaga-82b344278/"><i class="bi bi-linkedin icon"></i></a>
                    </section>
                ...
                <section id="c2" className="caixas">
                    ...
                    <section id="prede">
                        <a className="linkIcon" class="social" target="_blank" href="https://github.com/coutinhogit"><i class="bi bi-github icon" /></a>
                        <a className="linkIcon" class="social" target="_blank" href="#"><i class="bi bi-instagram icon"></i></a>
                        <a className="linkIcon" class="social" target="_blank" href="https://www.linkedin.com/in/gabriel-coutinho-cezar-b2b8821b7/"><i class="bi bi-linkedin icon"></i></a>
                ...
                <section id="c3" className="caixas">
                    ...
                    <section id="prede">
                        <a className="linkIcon" class="social" target="_blank" href="https://github.com/110320011"><i class="bi bi-github icon" /></a>
                        <a className="linkIcon" class="social" target="_blank" href="#"><i class="bi bi-instagram icon"></i></a>
